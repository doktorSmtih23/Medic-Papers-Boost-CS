    ...
    const prompt = `
        ...
        1.  **summary**: A single, self-contained HTML string. This is the most critical output.
            **CRITICAL INSTRUCTION FOR SUMMARY DETAIL:** Based on the user's choice, generate the summary with the following level of detail: ${detailInstruction}.
            The summary's HTML MUST be visually engaging, professional, and well-structured for a standard light theme.
            *   **A Self-Contained \`<style>\` Block (MANDATORY):**
                *   The CSS must create a professional, modern, and fully responsive layout. The base font should be 'Inter', sans-serif. Use a professional light theme color palette.
                ...
                *   **Clinical Pearls:** Style \`<blockquote>\` elements as prominent callouts with a background and border to highlight key clinical advice.
...
// --- components/AiThinkingProcess.tsx ---
const AiThinkingProcess: React.FC = () => {
    ...
    const analysisSteps = [
        ...
        "Identifying key medical concepts and terminology...",
        "Structuring main topics and sections...",
        "Generating concise summary and key takeaways...",
        "Creating interactive quiz questions...",
        "Designing study flashcards...",
